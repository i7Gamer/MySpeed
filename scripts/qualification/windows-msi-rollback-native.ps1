...
public static class MyspeedMsiRollbackNative
{
    ...
    public sealed class CallbackState{
        readonly string predecessorCode,targetPath,fileToken,directoryToken;readonly long payloadBytes;readonly DirectorySecurityLease lease;readonly InstallContextTracker installContext;
        ...
        public CallbackState(string predecessor,string candidate,string target,string expectedFileToken,string expectedDirectoryToken,long expectedBytes,DirectorySecurityLease security){predecessorCode=predecessor;targetPath=Path.GetFullPath(target);fileToken=expectedFileToken;directoryToken=expectedDirectoryToken;payloadBytes=expectedBytes;lease=security;installContext=new InstallContextTracker(candidate,predecessor);}
