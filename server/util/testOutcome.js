...
// Re-exported from their historical home: every reader of the failure
// predicates found these here, and the move to metricValue.js (made so
// helpers.js could read usableFigure, and so the two metric sinks could read
// the latency trio, without dragging sequelize into the integrations) must not
// break a single import.
export { UNMEASURED_LATENCY, isMeasuredLatency, measuredPing, usableFigure } from './metricValue.js';
